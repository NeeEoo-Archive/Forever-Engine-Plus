...
class StoryMenuState extends MusicBeatState
{
	...
	var weeksList:Array<meta.CoolUtil.WeekFile>;
	...
	{
		var newImage:flixel.graphics.FlxGraphic = Paths.image('menus/storymenu/difficulties/$diff');
	...
	function updateBG()
	{
		if (yellowBG != null)
		{
			if (weeksList[curWeek].week_bg != null)
				yellowBG.loadGraphic(Paths.image('menus/storymenu/bgs/${weeksList[curWeek].week_bg}'));
			else
